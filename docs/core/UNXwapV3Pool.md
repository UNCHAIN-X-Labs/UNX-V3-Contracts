...
```solidity
contract IUNXwapV3LmPool lmPool
```
...
```solidity
struct UNXwapV3Pool.Slot0 slot0
```
...
```solidity
struct UNXwapV3Pool.ProtocolFees protocolFees
```
...
_This setter should only be called immediately after this contract is deployed._
